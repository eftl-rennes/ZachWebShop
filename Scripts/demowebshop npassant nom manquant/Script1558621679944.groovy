...
WebUI.setText(findTestObject('Object Repository/Page_Demo Web Shop. Register/input_First name_FirstName (1)'), '')

WebUI.setText(findTestObject('Object Repository/Page_Demo Web Shop. Register/input_Last name_LastName (1)'), findTestData(
        'test').getValue(1, 2))
